...
sudo scutil --set ComputerName "WOPR"
sudo scutil --set HostName "WOPR"
sudo scutil --set LocalHostName "WOPR"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "WOPR"
